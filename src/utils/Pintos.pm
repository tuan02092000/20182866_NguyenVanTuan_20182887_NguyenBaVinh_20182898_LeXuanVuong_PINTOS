...
sub read_loader {
    my ($name) = @_;
    $name = find_file ("/home/tuannguyen/pintos-anon-master/src/threads/build/loader.bin") if !defined $name;
    #  $name = find_file ("/home/tuannguyen/pintos-anon-master/src/userprog/build/loader.bin") if !defined $name;
